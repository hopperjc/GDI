...
INSERT INTO tb_funcionario(cpf, nome_completo, data_nascimento, telefones, cep, logradouro, numero, complemento, bairro, cargo) VALUES ('111.222.333.44', 'José da Silva', to_date('01/01/1969', 'dd/mm/yy'), tp_telefones((tp_telefone('81', '99999-9999')), (tp_telefone('81', '99999-8888'))), '00000-010', 'Rua da esquina', 123, 'apt. 1', 'esquina', 01);

INSERT INTO tb_funcionario(cpf, nome_completo, data_nascimento, telefones, cep, logradouro, numero, complemento, bairro,cargo) VALUES ('222.333.444-55', 'Ana Sobral', to_date('24/04/1987', 'dd/mm/yy'), tp_telefones((tp_telefone('81', '88888-8888')), (tp_telefone('81', '88888-7777'))), '11111-121', 'Rua da entrada', 234, 'apt. 401', 'entrada', 03);

INSERT INTO tb_funcionario(cpf, nome_completo, data_nascimento, telefones, cep, logradouro, numero, complemento, bairro,cargo) VALUES ('333.444.555-66', 'Lucas Cavalcanti', to_date('14/03/1992', 'dd/mm/yy'), tp_telefones((tp_telefone('81', '77777-7777')),(tp_telefone('81', '77777-6666'))), '22222-232', 'Rua da saida', 345, 'Casa 12', 'saida', 02);
