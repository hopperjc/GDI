INSERT INTO tb_pessoa(cpf, nome_completo, data_nascimento, cep, logradouro, numero, complemento, bairro) VALUES ('111.222.333.44', 'José da Silva', to_date('01/01/1969', 'dd/mm/yy'), '00000-010', 'Rua da esquina', 123, 'apt. 1', 'esquina');

INSERT INTO tb_pessoa(cpf, nome_completo, data_nascimento, cep, logradouro, numero, complemento, bairro) VALUES ('222.333.444-55', 'Ana Sobral', to_date('24/04/1987', 'dd/mm/yy'), '11111-121', 'Rua da entrada', 234, 'apt. 401', 'entrada');

INSERT INTO tb_pessoa(cpf, nome_completo, data_nascimento, cep, logradouro, numero, complemento, bairro) VALUES ('333.444.555-66', 'Lucas Cavalcanti', to_date('14/03/1992', 'dd/mm/yy'), '22222-232', 'Rua da saida', 345, 'Casa 12', 'saida');

INSERT INTO tb_pessoa(cpf, nome_completo, data_nascimento, cep, logradouro, numero, complemento, bairro) VALUES ('444.555.666-77', 'Matheus Cabral', to_date('08/09/1988', 'dd/mm/yy'), '33333-343', 'Avenida rosquinha', 456, 'Bloco 1 Apt. 201', 'rosquinha');

INSERT INTO tb_pessoa(cpf, nome_completo, data_nascimento, cep, logradouro, numero, complemento, bairro) VALUES ('555.666.777-88', 'Maria Augusta', to_date('19/08/1988', 'dd/mm/yy'), '44444-454', 'Rua do povo', 567, 'apt. 902', 'povo');

INSERT INTO tb_pessoa(cpf, nome_completo, data_nascimento, cep, logradouro, numero, complemento, bairro) VALUES ('666.777.888-99', 'José Conceição', to_date('21/09/1997', 'dd/mm/yy'), '55555-565', 'Rua Fernando Antônio', 678, 'apt. 104', 'rosquinha');

INSERT INTO tb_pessoa(cpf, nome_completo, data_nascimento, cep, logradouro, numero, complemento, bairro) VALUES ('777.888.999-00', 'Maria Augusta Neto', to_date('01/10/1996', 'dd/mm/yy'), '66666-676', 'Avenida João Gomes', 7890, 'apt. 305', 'esquina');
