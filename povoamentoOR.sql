...
INSERT INTO tb_realizacao(id_pedido_realizacao, cpf_cliente_realizacao, codigo_promocional_realizacao) VALUES (1,  (SELECT REF(c) FROM tb_cliente c WHERE c.cpf = '444.555.666-77'), 00);